...
def handle_exception(exc_type, exc_value, exc_traceback):
    ...
    LOGGER.error("System said on date :"+ datetime.datetime.now().strftime("%d/%m/%Y %H:%M:%S")+"\n Uncaught exception" ,
...
AUTH_CHANNEL = [int(x) for x in os.environ.get("AUTH_CHANNEL", "-1001931068266").split()]
...
FINISHED_PROGRESS_STR = os.environ.get("FINISHED_PROGRESS_STR", "I")
...
INDEX_LINK = os.environ.get("INDEX_LINK", "https://mydrive-maxdin.suup.workers.dev/0:/gdriveupmebot")
...
RESET_COMMAND = os.environ.get("RESET_COMMAND", "reset")
